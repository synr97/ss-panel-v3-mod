...
class UserController extends BaseController
{
    ...
    public function index($request, $response, $args)
    {
        ...
        $ss_url_0_new = urlencode(Config::get('apiUrl').'/link/'.$ios_token.'?is_mu=0&new=1');
        $ss_url_1_new = urlencode(Config::get('apiUrl').'/link/'.$ios_token.'?is_mu=1&new=1');
        ...
        $v2_url_x = Tools::base64_url_encode('https://tgbot.lbyczf.com/v2rayN2quan?group=Dler%20Cloud%20-%20V2Ray&url='.Config::get('apiUrl').'/link/'.$ssr_sub_token.'?mu=2');
