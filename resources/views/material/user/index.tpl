									...
									<div class="tab-content" id="myTabContent">
										...
										<div class="tab-pane fade" id="all_ss" role="tabpanel" aria-labelledby="all_ss-tab">
											...
											{if URL::SSCanConnect($user)}
												...
												<p><a href="Shadowrocket://add/sub://{$ss_url}?remarks=Dler%20Cloud%20-%20SS" target="_blank" class="btn btn-primary mt-4">&nbsp;Shadwrocket<br>一键导入订阅</a></p>
											...
											{if URL::SSCanConnect($user)}
												...
												<p><a href="surge:///install-config?url={$surge2_0}" target="_blank" class="btn btn-primary mt-4">&nbsp;Surge 2 / Surge 3 Pro<br>一键托管&规则</a></p>
											{/if}
											{if URL::SSRCanConnect($user)}
												...
												<p><a href="surge:///install-config?url={$surge2_1}" target="_blank" class="btn btn-primary mt-4">&nbsp;Surge 2 / Surge 3 Pro<br>一键托管&规则</a></p>
											{/if}
											<hr>
											{if URL::SSCanConnect($user)}
												<p>Surge 3 Pro 个人端口托管地址（MitM）</p>
												<p><code><a class="copy-text" data-clipboard-text="{$apiUrl}/link/{$ios_token}?is_mu=0&surge=3">{$apiUrl}/link/{$ios_token}?is_mu=0&surge=3</a></code></p>
												<p><a href="surge3:///install-config?url={$surge3_0}" target="_blank" class="btn btn-primary mt-4">&nbsp;Surge 3 Pro<br>一键托管&规则</a></p>
											{/if}
											{if URL::SSRCanConnect($user)}
												<p>Surge 3 Pro 公共端口托管地址（MitM）</p>
												<p><code><a class="copy-text" data-clipboard-text="{$apiUrl}/link/{$ios_token}?is_mu=1&surge=3">{$apiUrl}/link/{$ios_token}?is_mu=1&surge=3</a></code></p>
												<p><a href="surge3:///install-config?url={$surge3_1}" target="_blank" class="btn btn-primary mt-4">&nbsp;Surge 3 Pro<br>一键托管&规则</a></p>
											{/if}
											<hr>
											{if URL::SSCanConnect($user)}
